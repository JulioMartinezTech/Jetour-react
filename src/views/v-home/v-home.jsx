  ...
  return (
    <div className="v-home">
      ...
      <div className="v-home__section__models">
        {modelSelected === "dashing" && (
          <div className="v-home__section__model__header">
            <h1 className="v-home__section__model__header__main-title">
              DASHING
            </h1>
            <Link
              to={"/modelos/dashing"}
              className="v-home__section__model__header__button"
            >
              Más información
            </Link>
          </div>
        ...
        <div className="v-home__section__model-selected">
          {modelSelected === "dashing" && (
            <img
              src={Dashing}
              alt="dashing"
              className="v-home__section__model-selected-image"
            />
          )}
          {modelSelected === "x70" && (
            <img
          ...
          {modelSelected === "t2" && (
            <img
              src={T2}
              alt="t2"
              className="v-home__section__model-selected-image v-home__section__model-selected-image-t2"
            />
          )}
        </div>
        <div className="v-home__section__models__options">
          <div
            className="v-home__section__models__option-group"
            onMouseEnter={X70HoverEnter}
            onMouseLeave={X70HoverLeave}
            onClick={() => {
              setModelSelected("x70");
            }}
          >
            {x70Hover || modelSelected === "x70" ? (
              <img
                src={X70MiniFront}
                alt="x70"
                className="v-home__section__models__option-image"
              />
            ) : (
              <img
                src={X70Mini}
          ...
          <div
            className="v-home__section__models__option-group"
            onMouseEnter={X70PlusHoverEnter}
            onMouseLeave={X70PlusHoverLeave}
            onClick={() => {
              setModelSelected("x70-plus");
            }}
          >
            {x70PlusHover || modelSelected === "x70-plus" ? (
              <img
                src={X70PlusMiniFront}
                alt="x70plus"
                className="v-home__section__models__option-image"
              />
            ) : (
          ...
          <div
            className="v-home__section__models__option-group"
            onMouseEnter={DashingHoverEnter}
            onMouseLeave={DashingHoverLeave}
            onClick={() => {
              setModelSelected("dashing");
            }}
          >
            {dashingHover || modelSelected === "dashing" ? (
              <img
                src={DashingMini}
                alt="dashing"
                className="v-home__section__models__option-image"
          ...
          <div
            className="v-home__section__models__option-group"
            onMouseEnter={X90PlusHoverEnter}
            onMouseLeave={X90PlusHoverLeave}
            onClick={() => {
              setModelSelected("x90-plus");
            }}
          >
            {x90PlusHover || modelSelected === "x90-plus" ? (
              <img
                src={X90PlusMiniFront}
                alt="x90plus"
                className="v-home__section__models__option-image"
              />
            ) : (
          ...
          <div
            className="v-home__section__models__option-group"
            onMouseEnter={T2HoverEnter}
            onMouseLeave={T2HoverLeave}
            onClick={() => {
              setModelSelected("t2");
            }}
          >
            {t2Hover || modelSelected === "t2" ? (
              <img
                src={T2MiniFront}
                alt="t2"
                className="v-home__section__models__option-image"
      ...
      <div className="v-home__section__innovation">
        <div className="v-home__section__innovation__group">
          ...
          <p className="v-home__section__innovation__text">
            Impulsado por la innovación, Jetour está decidida a ser la marca
            líder dentro de su segmento y convertirse en una marca influyente y
            confiable para su público.
          </p>
          <p className="v-home__section__innovation__text">
            Jetour, marca respaldada por Movilidad Inteligente MARTÍ (MOVITI).
          </p>
          <Link
            to={"/novedades"}
            className="v-home__section__innovation__button"
          >
        ...
        <div className="v-home__section__innovation__group">
          <video
            src={InnovationVideo}
            className="v-home__section__innovation__video"
            controls
          ></video>
        </div>
      </div>
      <div className="v-home__section__features">
        <div className="v-home__section__features__items">
          <Link
            to={"/modelos/x70"}
            className="v-home__section__features__item-a"
          >
          ...
          <div className="v-home__section__features__item-b">
            <Link
              to={"/modelos/x70-plus"}
              className="v-home__section__features__item__text-group"
            >
              <p>X70 PLUS</p>
      ...
      <div className="v-home__section__news">
        <div className="v-home__section__news__group__left">
          <h2 className="v-home__section__news__title">NOVEDADES</h2>
        </div>
        <div className="v-home__section__news__group__right">
          <Link
            to={"/novedades/lidom-grupo-marti-firma-alianza"}
            className="v-home__section__news__item"
          >
            <p className="v-home__section__news__item__title">
              LIDOM y Grupo Martí firman alianza
            </p>
            <p className="v-home__section__news__item__text">17.10.23</p>
            <img
              src={process.env.PUBLIC_URL + "/Images/dashing-exterior5.jpg"}
              alt="jetour"
              className="v-home__section__news__item__image"
            />
          </Link>
          <Link
            to={"/novedades/nueva-propuesta-grupo-marti"}
            className="v-home__section__news__item"
          >
            <p className="v-home__section__news__item__title">
              La nueva propuesta de Grupo Martí
            </p>
            <p className="v-home__section__news__item__text">10.07.23</p>
            <img
              src={process.env.PUBLIC_URL + "/Images/x70PLus-exterior2.jpg"}
              alt="jetour"
              className="v-home__section__news__item__image"
            />
          </Link>
      ...
      <div className="v-home__section__float-button">
        <a href="https://citas.moviti.do/" className="v-home__cta">
          Solicita tu test drive
        </a>
      </div>
      <CScrollUp />
      <CFooter />
