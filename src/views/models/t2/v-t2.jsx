    ...
    <div className="v-t2">
      ...
      <div className="v-t2__content-nav">
        <div className="v-t2__model-nav__actions">
          <div className="v-t2__model-nav__nav-items">
            <a href="#overview" className="v-t2__model-nav__nav-item">
              Visión general
            </a>
            <a href="#details" className="v-t2__model-nav__nav-item">
              Detalles
            </a>
            <a href="#gallery" className="v-t2__model-nav__nav-item">
              Galería
            </a>
            <a href="#config" className="v-t2__model-nav__nav-item">
              Configuración
            </a>
          </div>
          <Link to={"/cotizar/t2"} className="v-t2__model-nav__button">
            Cotizar ahora
          </Link>
        </div>
      </div>
      <div className="v-t2__section__overview" id="overview">
        <div className="v-t2__section__overview__info-container">
          {color !== "white" && (
            <div className="v-t2__section__overview__details-container">
              <div className="v-t2__section__overview__details-group">
                <p className="v-t2__section__overview__detail-title">
                  Tracción
                </p>
              ...
              <a
                href="https://jetourglobal.com/pages/360/T2.html"
                className="v-t2__section__overview__3d-button"
              >
                Visualizador 3D
              </a>
              <Link
                to={"/cotizar/t2"}
                className="v-t2__model-nav__button__black"
              >
                Cotizar ahora
              </Link>
            </div>
          ...
          {color === "white" && (
            <div className="v-t2__section__overview__details-container">
              <div className="v-t2__section__overview__details-group">
                <p className="v-t2__section__overview__detail-title text-black">
                  Tracción
                </p>
                <h2 className="v-t2__section__overview__detail text-black">
                  4WD
                </h2>
              </div>
              <div className="v-t2__section__overview__details-group">
          ...
          <div className="v-t2__section__overview__colors">
            <div
              className="v-t2__section__overview__color v-t2__section__overview__color-silver"
              onClick={() => {
                setColor("silver");
              }}
            ></div>
            <div
              className="v-t2__section__overview__color v-t2__section__overview__color-gray"
              onClick={() => {
                setColor("gray");
              }}
            ></div>
            <div
              className="v-t2__section__overview__color v-t2__section__overview__color-black"
              onClick={() => {
                setColor("black");
              }}
            ></div>
            <div
              className="v-t2__section__overview__color v-t2__section__overview__color-sand"
              onClick={() => {
                setColor("sand");
              }}
            ></div>
            <div
              className="v-t2__section__overview__color v-t2__section__overview__color-cyan"
              onClick={() => {
                setColor("cyan");
              }}
            ></div>
        ...
        {color === "silver" && (
          <div className="v-t2__section__overview__background v-t2__section__overview__background-silver">
            <div className="v-t2__section__overview__background__title-group">
              ...
              <p className="v-t2__section__overview__background__text">
                PLATEADO
              </p>
            </div>
          </div>
        ...
        {color === "gray" && (
          <div className="v-t2__section__overview__background v-t2__section__overview__background-gray">
            <div className="v-t2__section__overview__background__title-group">
              <h2 className="v-t2__section__overview__background__title">T2</h2>
        ...
        {color === "black" && (
          <div className="v-t2__section__overview__background v-t2__section__overview__background-balck">
            <div className="v-t2__section__overview__background__title-group">
              <h2 className="v-t2__section__overview__background__title">T2</h2>
        ...
        {color === "orange" && (
          <div className="v-t2__section__overview__background v-t2__section__overview__background-orange">
            <div className="v-t2__section__overview__background__title-group">
              <h2 className="v-t2__section__overview__background__title">T2</h2>
              <p className="v-t2__section__overview__background__text">
                NARANJA
        ...
        {color === "sand" && (
          <div className="v-t2__section__overview__background v-t2__section__overview__background-sand">
            <div className="v-t2__section__overview__background__title-group">
              <h2 className="v-t2__section__overview__background__title">T2</h2>
        ...
        {color === "cyan" && (
          <div className="v-t2__section__overview__background v-t2__section__overview__background-cyan">
            <div className="v-t2__section__overview__background__title-group">
              <h2 className="v-t2__section__overview__background__title">T2</h2>
        ...
        {color === "green" && (
          <div className="v-t2__section__overview__background v-t2__section__overview__background-green">
            <div className="v-t2__section__overview__background__title-group">
              <h2 className="v-t2__section__overview__background__title">T2</h2>
        ...
        {color === "silver" && (
          <div className="v-t2__section__overview__image-container">
            <img
              src={T2Silver}
              alt=""
              className="v-t2__section__overview__image"
            />
          </div>
        )}
        {color === "gray" && (
      ...
      <div className="v-t2__section__design" id="details">
        <div className="v-t2__section__design__info-container no-show-mobile">
          ...
          <div className="v-t2__section__design__text-group">
            <p className="v-t2__section__design__text">
          ...
          <div className="v-t2__section-style__content-group__items">
            <div className="v-t2__section-style__content-group__item">
              <img
                src={Style1}
                alt=""
                className="v-t2__section-style__content-group__item__image"
              />
              <p className="v-t2__section-style__content-group__item__text">
                Rack de equipaje
              </p>
            </div>
            <div className="v-t2__section-style__content-group__item">
      ...
      <div className="v-t2__section-accordion" id="config">
        <CAccordion
          ...
          url="https://holajetour.do/test/#/modelos/t2"
        />
      </div>
      <CScrollUp />
      <CFooter />
