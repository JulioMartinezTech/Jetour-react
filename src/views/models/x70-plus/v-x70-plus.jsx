    ...
    return (
        <div className='v-x70-plus'>
            ...
            <div className='v-x70-plus__content-nav'>
                ...
                <div className='v-x70-plus__model-nav__actions'>
                    <div className='v-x70-plus__model-nav__nav-items'>
                        ...
                        <a href="#gallery"  className='v-x70-plus__model-nav__nav-item'>Galería</a>
                ...
                <div className='v-x70-plus__section__overview__info-container'>
                    {color !== 'white' && <div className='v-x70-plus__section__overview__details-container'>
                        <div className='v-x70-plus__section__overview__details-group'>
                            <p className='v-x70-plus__section__overview__detail-title'>Doble pantalla digital de:</p>
                            <h2 className='v-x70-plus__section__overview__detail'>10.25"</h2>
                        </div>
                        <div className='v-x70-plus__section__overview__details-group'>
                            <p className='v-x70-plus__section__overview__detail-title'>Cámara de:</p>
                            <h2 className='v-x70-plus__section__overview__detail'>360°</h2>
                        </div>
                        <div className='v-x70-plus__section__overview__details-group'>
                            <p className='v-x70-plus__section__overview__detail-title'>Aros</p>
                    ...
                    {color === 'white' && <div className='v-x70-plus__section__overview__details-container'>
                        <div className='v-x70-plus__section__overview__details-group'>
                            <p className='v-x70-plus__section__overview__detail-title text-black'>Doble pantalla digital de:</p>
                            <h2 className='v-x70-plus__section__overview__detail text-black'>10.25"</h2>
                        </div>
                        <div className='v-x70-plus__section__overview__details-group'>
                            <p className='v-x70-plus__section__overview__detail-title text-black'>Cámara de:</p>
                            <h2 className='v-x70-plus__section__overview__detail text-black'>360°</h2>
                        </div>
                        <div className='v-x70-plus__section__overview__details-group'>
                            <p className='v-x70-plus__section__overview__detail-title text-black'>Aros</p>
                            <h2 className='v-x70-plus__section__overview__detail text-black'>20"</h2>
                        </div>
                        <a href="http://platanogeek.com/x70plus_720/" className='v-x70-plus__section__overview__3d-button'>Visualizador 3D</a>
                        <Link to={'/cotizar/x70-plus'} className='v-x70-plus__model-nav__button__black'>Cotizar ahora</Link>
                    </div>}
            ...
            <div className='v-x70-plus__section__design' id="details">
                ...
                <div className='v-x70-plus__section__design__info-container'>
                    <div className='v-x70-plus__section__design__text-group'>
                        ...
                        <p className='v-x70-plus__section__design__text'>Techo Panorámico</p>
                    </div>
            ...
            <div className='v-x70-plus__section-accordion' id="config">
                <CAccordion data={data.techConfig} title="TABLA DE CONFIGURACIÓN" url="https://holajetour.do/test/#/modelos/x70-plus"/>
            </div>
            <CScrollUp/>
            <CFooter />
        </div>
