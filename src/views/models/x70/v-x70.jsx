    ...
    return (
        <div className='v-x70'>
            ...
            <div className='v-x70__content-nav'>
                ...
                <div className='v-x70__model-nav__actions'>
                    <div className='v-x70__model-nav__nav-items'>
                        ...
                        <a href="#gallery"  className='v-x70__model-nav__nav-item'>Galería</a>
                ...
                <div className='v-x70__section__overview__info-container'>
                    {color !== 'white' && <div className='v-x70__section__overview__details-container'>
                        <div className='v-x70__section__overview__details-group'>
                            <p className='v-x70__section__overview__detail-title'>Capacidad</p>
                            <h2 className='v-x70__section__overview__detail'>7 pasajeros</h2>
                        </div>
                        <div className='v-x70__section__overview__details-group'>
                        ...
                        <div className='v-x70__section__overview__details-group'>
                            <p className='v-x70__section__overview__detail-title'>Compuerta trasera</p>
                    ...
                    {color === 'white' && <div className='v-x70__section__overview__details-container'>
                        <div className='v-x70__section__overview__details-group'>
                            <p className='v-x70__section__overview__detail-title text-black'>Capacidad</p>
                            <h2 className='v-x70__section__overview__detail text-black'>7 pasajeros</h2>
                        </div>
                        <div className='v-x70__section__overview__details-group'>
                            <p className='v-x70__section__overview__detail-title text-black'>Aros</p>
                            <h2 className='v-x70__section__overview__detail text-black'>20"</h2>
                        </div>
                        <div className='v-x70__section__overview__details-group'>
                            <p className='v-x70__section__overview__detail-title text-black'>Compuerta trasera</p>
                            <h2 className='v-x70__section__overview__detail text-black'>Eléctrica</h2>
                        </div>
                        <a href="https://jetourglobal.com/spain/x70-720" className='v-x70__section__overview__3d-button'>Visualizador 3D</a>
                        <Link to={'/cotizar/x70'} className='v-x70__model-nav__button__black'>Cotizar ahora</Link>
                    </div>}
            ...
            <div className='v-x70__section__design' id="details">
                <div className='v-x70__section__design__info-container no-show-mobile'>
                    ...
                    <div className='v-x70__section__design__text-group'>
                        <p className='v-x70__section__design__text'>Cluster de instrumentos de 12.3”</p>
                    </div>
                </div>
                <div className='v-x70__section__design__info-container'>
                    <div className='v-x70__section__design__text-group'>
                        {/* <h2 className='v-x70__section__design__title'>EXPERIENCIA FLUIDA</h2> */}
                        <p className='v-x70__section__design__text'>Techo panorámico y sunroof</p>
                    </div>
            ...
            <div className='v-x70__section-accordion' id="config">
                <CAccordion data={data.techConfig} title="TABLA DE CONFIGURACIÓN" url="https://holajetour.do/test/#/modelos/x70"/>
            </div>
            <CScrollUp/>
            <CFooter />
        </div>
